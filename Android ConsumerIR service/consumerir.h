...
typedef struct consumerir_device {
    ...
    int (*get_device_info)(struct consumerir_device *dev);

	int (*get_device_state)(struct consumerir_device *dev);

	int (*get_learn_code)(struct consumerir_device *dev,int *code);

	int (*learnCmd)(struct consumerir_device *dev,int cmd);
